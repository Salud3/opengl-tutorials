...
0,      -(sqrt(6) / 3) / 2+y,		   -.5773502691896f,			0.83f, 0.70f, 0.44f,	0.294f, 0.668f,
0.5f,   -(sqrt(6) / 3) / 2+y,				sqrt(3) / 6,			0.83f, 0.70f, 0.44f,	0.432f, 0.347f,
-0.5f,  -(sqrt(6) / 3) / 2+y,				sqrt(3) / 6,			0.83f, 0.70f, 0.44f,	0.159f, 0.347f,
0,       (sqrt(6) / 3) / 2+y,						  0,			0.92f, 0.86f, 0.76f,	0.582f, 0.668f,
0,       (sqrt(6) / 3) / 2+y,						  0,			0.92f, 0.86f, 0.76f,	0.0f, 0.668f,
0,       (sqrt(6) / 3) / 2+y,						  0,			0.92f, 0.86f, 0.76f,	0.293f, 0.0f  
};
...
GLfloat verticesC[] =
{ //     COORDINATES															/        COLORS      /   TexCoord  //
0,      -(sqrt(6)/3)/2 ,   0                          -0.5773507f,				0.83f, 0.70f, 0.44f,	0.489f,	0.333f,
0.5f,   -(sqrt(6)/3)/2 ,   sqrt(3)/2            -0.5773507f,					0.83f, 0.70f, 0.44f,	0.611f,	0.056f,
-0.5f,  -(sqrt(6)/3)/2 ,   sqrt(3)/2            -0.5773507f,					0.83f, 0.70f, 0.44f,	0.731f,	0.333f,
0,       (sqrt(6)/3)/2 ,   (sqrt(3)/2)+.2886756f -0.5773507f,					0.92f, 0.86f, 0.76f,	0.863f,	0.622f,
0.5f,    (sqrt(6)/3)/2 ,   .2886756f                   -0.5773507f,				0.92f, 0.86f, 0.76f,	0.365f,	0.625f,
-0.5f,   (sqrt(6)/3)/2 ,   .2886756f                   -0.5773507f,				0.92f, 0.86f, 0.76f,	0.62f,	0.62f,
0.5f,   -(sqrt(6) / 3) / 2 ,   sqrt(3) / 2 - 0.5773507f,						0.83f, 0.70f, 0.44f,	0.249f,	0.333f,
- 0.5f, -(sqrt(6) / 3) / 2 ,   sqrt(3) / 2 - 0.5773507f,						0.83f, 0.70f, 0.44f,	0,		0.33f,
0,       (sqrt(6) / 3) / 2 ,   (sqrt(3) / 2) + .2886756f - 0.5773507f,			0.83f, 0.70f, 0.44f,	0.122f,	0.627f,
- 0.5f,  (sqrt(6) / 3) / 2 ,   .2886756f - 0.5773507f,							0.92f, 0.86f, 0.76f,	0.251f,	0.904f
};																				

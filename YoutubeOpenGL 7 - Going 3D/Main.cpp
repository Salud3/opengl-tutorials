...
GLfloat vertices[] =
{
	  0.0f,  0.8f,  0.0f,     0.83f, 0.70f, 0.44f,    0.463127f, 0.918442f,   //punto pivote superior

	  //caras superiores
	0.0f,    0.0f,  0.894f, 0.83f, 0.70f, 0.44f,   0.797955f, 0.189685f,
	0.851f,  0.0f,  0.276f, 0.83f, 0.70f, 0.44f,   0.125553f, 0.186026f,
	0.526f,  0.0f, -0.723f, 0.83f, 0.70f, 0.44f,   0.797955f, 0.189685f,
   -0.526f,  0.0f, -0.723f, 0.83f, 0.70f, 0.44f,   0.125553f, 0.186026f,
   -0.851f,  0.0f,  0.276f, 0.83f, 0.70f, 0.44f,   0.125553f, 0.186026f,

   //caras inferiores
	0.0f,   0.0f,  0.894f, 0.83f, 0.70f, 0.44f,   0.125553f, 0.186026f,
	0.851f, 0.0f,  0.276f, 0.83f, 0.70f, 0.44f,   0.797955f, 0.189685f,
	0.526f, 0.0f, -0.723f, 0.83f, 0.70f, 0.44f,   0.125553f, 0.186026f,
   -0.526f, 0.0f, -0.723f, 0.83f, 0.70f, 0.44f,   0.797955f, 0.189685f,
   -0.851f, 0.0f,  0.276f, 0.83f, 0.70f, 0.44f,   0.125553f, 0.186026f,

	0.0f, -0.8f,  0.0f,     0.83f, 0.70f, 0.44f, 0.463127f, 0.918442f //punto pivote inferior
};
...
int main()
{
	...
	*/
	...
	// Texture
	Texture brickTex((parentDir + texPath + "triaungulo.png").c_str(), GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
	brickTex.texUnit(shaderProgram, "tex0", 0);
